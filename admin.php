...
<body>
  <div class="page">
    <div class="panel">
      <div class="container">
        <div class="main-menu">
          <a href="#" class="main-menu__btn btns-admin">Просмотреть заявки</a>
          <a href="#" class="main-menu__btn btns-admin">Добавить животное</a>
          <div class="col-md-6 mb-3 flex">
            ...
            <a href="#" class="btns-admin-search">Выход</a>
          </div>
        </div>
      </div>
    </div>
